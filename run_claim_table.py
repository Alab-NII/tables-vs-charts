...
OUTPUT_DIR = f"outputs/claim_task_table"
...
dataset_file = "data/scitab_align_plus/data.json"
...
for item in tqdm(samples):
    ...
    prompt, response = run_claim_task(item["claim"], table, image_path, image_caption, model, shots=prompt_type, **kwargs)
    #
    results.append({
        "id": item["id"],
        "claim": item["claim"],
